...
- **[x] 1 · Scalar autodiff.** A scalar reverse-mode automatic-differentiation engine in Rust, standard library only. *Done bar:* analytic gradients match numerical (finite-difference) gradients to ~1e-6 on a composed expression.
